...
const upcomingEvents = [
  {
    ...
    title: "Γιορτή Αγίου Σοφρονίου",
    time: "09:00",
    description: "Ειδική λειτουργία για τον πολιούχο της πόλης μας. Θα ακολουθήσει δεξίωση στην αίθουσα της εκκλησίας.",
    type: "feast",
    location: "Κεντρικός Ναός"
  },
  {
    date: "15 Οκτωβρίου 2025",
    title: "Φιλανθρωπικό Bazaar",
    time: "10:00 - 18:00",
    description: "Ετήσιο bazaar για στήριξη των φιλανθρωπικών μας δράσεων. Παραδοσιακά προϊόντα, χειροποίητα και νόστιμο φαγητό.",
    type: "event",
    location: "Προαύλιος χώρος εκκλησίας"
  },
  {
  ...
  {
    date: "31 Δεκεμβρίου 2025",
    title: "Ευχαριστήριος Μολεβός",
    time: "18:00",
    description: "Ευχαριστήριο μολεβό για τη χρονιά που πέρασε και ευλογία για τη νέα χρονιά.",
    type: "prayer",
    location: "Κεντρικός Ναός"
  }
]
